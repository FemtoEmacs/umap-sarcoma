(:FORMAT :UMAP-PROBLEM :VERSION 1 :TITLE
 ...
 (:FILE "pilot-search-best-data.sexp" :RECORDS-KEY :RECORDS :ID-FIELD :ID
 ...
 (:NEIGHBORS 20 :MINIMUM-DISTANCE 0.4d0 :EPOCHS 35 :SEED 20260831
  :DENSITY-SURFACE T :DENSITY-BANDWIDTH 45 :DENSITY-THRESHOLDS 10
  :DENSITY-OPACITY 0.18d0 :DENSITY-COLOR "data" :DENSITY-COLOR-BANDS 7
  :POINT-RADIUS 6)
 :SCORING
