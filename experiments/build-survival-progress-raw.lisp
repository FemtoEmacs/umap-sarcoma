;;;; Experiment 5: survival progress with untransformed survival coordinates.
...
(setf *evidence-include-survival-progress* t
      *evidence-survival-transform* :identity)
...
(let* ((source (experiment-read
       ...
       (output (merge-pathnames "survival-progress-raw-windows.sexp"
                                *experiment-root*)))
  ...
  (format t "Wrote ~A with ~D raw-survival records.~%" output (length records)))
