(:format :umap-problem :version 1
 :title "Experiment 5: survival progress with raw survival"
 :data (:file "survival-progress-raw-windows.sexp" :records-key :records
        :id-field :id :embedding ((:field :vector))
        :validation (:required-fields (:id :vector :curve :sarcoma-type :therapy)
                     :unique-fields (:id)))
