(:format :umap-problem
 :version 1
 :title "Experiment 1: twenty temporal anchors"
 :data (:file "temporal-20-windows.sexp"
        :records-key :records :id-field :id
        :embedding ((:field :vector))
        :validation (:required-fields (:id :vector :curve :sarcoma-type :therapy)
                     :unique-fields (:id)))
 :preprocessing (:standardize true)
 :umap (:neighbors 200 :minimum-distance 0.72 :epochs 500 :seed 20260831
